...
<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	<div class="news-item" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
		...
		<?if($arParams["DISPLAY_NAME"]!="N" && $arItem['PROPERTIES']['NAME_EN']['VALUE']):?>
				<div class="news-title"><?echo $arItem['PROPERTIES']['NAME_EN']['VALUE']?></div>
		<?endif;?>
		<?if($arParams["DISPLAY_PREVIEW_TEXT"]!="N" && $arItem['PROPERTIES']['PREVIEW_TEXT_EN']['VALUE']):?>
			<div class="news-detail"><?echo $arItem['PROPERTIES']['PREVIEW_TEXT_EN']['VALUE'];?></div>
		<?endif;?>
		<?if($arParams["DISPLAY_PICTURE"]!="N" && is_array($arItem["PREVIEW_PICTURE"])):?>
